# MSR 10.15 with JDBC Adapter, MQ Adapter, CU, CDS and CloudStreams Test #1

Purpose of this test is to verify the minimum installation of template `MSR/1015/cu_cds_jdbc_mq`.
